//------------------------------------------
//           PAGE TEMPLATE ARTICLE (COMPOSANT)/STRUCTURE DE TOUT LES ARTICLES
//------------------------------------------
...
const ArticlePage = () => {
    ...
    // RECUPERER L'ARTICLE AYANT UN ID CORRESPONDANT A CELUI DE L'URL POUR ENSUITE AFFICHER CES VALEURS DANS LE RETURN
    useEffect(() => {
        let selected = articles.find(art => art.id === parseInt(id)) // L'ARTICLE RECUPERER EST STOCKE DANS LA VARIABLE "selected"
